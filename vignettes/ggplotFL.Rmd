...
%\VignetteIndexEntry{Using ggplotFL}
-->
...
```
* Any bug, question or suggestion on `ggplotFL` can be notified to the developers at its issue page ^[https://github.com/flr/ggplotFL/issues]
