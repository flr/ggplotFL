...
% Iago Mosqueira, EC JRC\thanks{
	...
	IPSC - Maritime Affairs Unit G.04\\
	Ispra, Italy} - FLR Project
% August 2013
...
## FLStock
```{r, flstock, echo=TRUE, tidy=TRUE, fig.cap="Overall `ggplot` of an `FLStock` object, facted by slot."}
ggplot(data=ple4, aes(year, data)) + geom_line() + facet_wrap(~qname, scales="free", nrow=3) + labs(x="", y="")
```
