...
```{r, pflqs, echo=TRUE, tidy=TRUE, fig.cap="Standard ggplot2-based plot for an FLQuants object with multiple iterations, and consisting of three elements."}
...
Coercion using `as.data.frame`, combined with the use of `cast` and `melt` (from the `reshape` package), provides the *FLR* user with the tools required to create a large range of `ggplot`s out of any *FLR* object.
